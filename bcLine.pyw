...
class Main:
    ...
    def run(self):
        ...
        f2 = tk.Frame(self.f1)
        f2.pack()
        tk.Button(f2, text="น้ำเงิน", fg="blue", command=lambda: self.text.insert("end", "น้ำเงิน")).pack(side="left")
        tk.Button(f2, text="แดง", fg="red", command=lambda: self.text.insert("end", "แดง")).pack(side="right")
